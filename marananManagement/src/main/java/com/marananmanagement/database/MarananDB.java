...
public class MarananDB extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "MarananManagement";
    private static final String FILE_DIR = "DataBase";
    public static String TABLE_NAME = "Alerts";
    ...
    public static final String AUDIO_ALERT = "audio_alert";
    ...
    public void insertRecords(SQLiteDatabase sqlite_dbase, GetterSetter getset) {
        ...
        insertStmt.bindString(2, getset.getAlertMessages());
        insertStmt.bindString(3, getset.getMode());
        insertStmt.bindString(4, getset.getState());
        insertStmt.bindString(5, getset.getTime_hr());
        insertStmt.bindString(6, getset.getTime_min());
        insertStmt.bindString(7, getset.getSun());
        insertStmt.bindString(8, getset.getMon());
        insertStmt.bindString(9, getset.getTues());
        insertStmt.bindString(10, getset.getWed());
        insertStmt.bindString(11, getset.getThur());
        insertStmt.bindString(12, getset.getFri());
        insertStmt.bindString(13, getset.getSat());
        insertStmt.execute();
    ...
    public void updateState(String id, String state) {
        ...
        try {
            sqlitedb = getWritableDatabase();
            String sql = "UPDATE " + TABLE_NAME + " SET " + STATE + "='" + state
                    + "'" + " WHERE " + DED_ID + "=" + id;
            cursor = sqlitedb.rawQuery(sql, null);
            if (cursor.moveToFirst()) {
                if (cursor.getInt(0) > 0) {
    ...
    public GetterSetter getAlertValues(String id) {
        ...
        if (cursor.moveToFirst()) {
            getset.setId(cursor.getString(1));
            getset.setAlertMessages(cursor.getString(2));
            getset.setMode(cursor.getString(3));
            getset.setState(cursor.getString(4));
            getset.setTime_hr(cursor.getString(5));
            getset.setTime_min(cursor.getString(6));
            getset.setSun(cursor.getString(7));
            getset.setMon(cursor.getString(8));
            getset.setTues(cursor.getString(9));
            getset.setWed(cursor.getString(10));
            getset.setThur(cursor.getString(11));
            getset.setFri(cursor.getString(12));
            getset.setSat(cursor.getString(13));
        }
